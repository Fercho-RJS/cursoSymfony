...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $emails = array('gmail.com', 'yahoo.com', 'msn.com',
            'hotmail.com', 'aol.com');
        ...
        $evento->setIdioma('es');
        //var_dump($this->getReference('javierFernandez'));exit;
        $evento->setDisertante(
                $manager->merge($this->getReference('javierFernandez'))
        );
        $evento = $this->addUsuarios($manager,$evento);
     ...
     */
    private function addUsuarios(ObjectManager $manager,$entidad, $num = null)
    {
        // Obtener el repositorio desde el ObjectManager
        $usuarioRepository = $manager->getRepository(\App\Entity\Usuario::class);

        // Traer todos los usuarios con findAll()
